...
public class ConfigLocale implements Config {
    ...
    public String enterUsePermission = this.prefix + "Enter the new use permission node into the chat.";

    public String enterDyePermission = this.prefix + "Enter the new dye permission node into the chat.";
