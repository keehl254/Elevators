...
public class MapConfigConverter extends ConfigConverter {
    ...
    public ConfigNode<?> deserializeNodeWithFieldAndObject(ConfigNode<?> parentNode, String key, Object object, FieldData fieldData) throws Exception {
        ...
        if (object instanceof Map<?, ?>) {
            ...
            ElevatorsAPI.log(Level.WARNING, "An invalid value was entered for key: " + key + ". Expected Map or Empty Array.");
        }
    ...
    public Object serializeValueToYamlObject(Object mapObj) throws Exception {
        ...
        for (Object key : map.keySet()) {
            ...
            if (converter != null)
                key = converter.serializeValueToYamlObject(key);

            converter = ConfigConverter.getConverter(value.getClass());
            if (converter != null)
                value = converter.serializeValueToYamlObject(value);
