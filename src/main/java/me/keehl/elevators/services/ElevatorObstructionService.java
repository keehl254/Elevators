...
public class ElevatorObstructionService extends ElevatorService implements IElevatorObstructionService {
    ...
    public void onInitialize() {
        ...
        ElevatorsAPI.popLog(logData -> ElevatorsAPI.log("Obstruction service enabled. "+ ChatColor.YELLOW + "Took " + logData.getElapsedTime() + "ms"));
    }
    ...
    public double getHitBoxAddition(Block block, Player player) {
