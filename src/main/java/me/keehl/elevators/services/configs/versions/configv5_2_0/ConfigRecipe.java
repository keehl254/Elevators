...
public class ConfigRecipe implements IConfigRecipe {
    ...
    public void setDefaultOutputColor(DyeColor defaultOutputColor) {
        this.defaultOutputColor = defaultOutputColor;
    }

    public void setMultiColorOutput(boolean supportMultiColorOutput) {
        this.supportMultiColorOutput = supportMultiColorOutput;
    }

    public void setMultiColorMaterials(boolean supportMultiColorMaterials) {
        this.supportMultiColorMaterials = supportMultiColorMaterials;
    }

    public void setRecipe(List<RecipeRow<NamespacedKey>> recipeKeys) {
        this.recipe = recipeKeys;
    }
