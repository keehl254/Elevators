...
public class ChargeExpAction extends ElevatorAction {
    ...
    public ChargeExpAction(JavaPlugin plugin, IElevatorType elevatorType, String key) {
    ...
    protected void onInitialize(String value) {
        ...
        IElevatorActionSetting<Integer> levelSetting = this.mapSetting(expLevelGrouping, "level","Levels", desc, Material.ENCHANTED_BOOK, ChatColor.GOLD, true);
        ...
        IElevatorActionSetting<Integer> expSetting = this.mapSetting(expGrouping, "exp","XP", desc, Material.EXPERIENCE_BOTTLE, ChatColor.YELLOW, true);
