package com.lkeehl.elevators.services.configs.versions.configv4;
...
public class V4ConfigRoot implements Config {
    ...
    public V4ConfigCommands commands = new V4ConfigCommands();

    public Map<String, com.lkeehl.elevators.services.configs.versions.configv4.V4ConfigRecipe> recipes = new HashMap<>();
